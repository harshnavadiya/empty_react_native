...
componentDidMount() { 
NetInfo.addEventListener(ddd=> {this.handleConnectivityChange(ddd.isConnected)}); 

} 

componentWillUnmount() { 
NetInfo.removeEventListener(ddd=>{this.handleConnectivityChange(ddd.isConnected)}); 
} 
